// Top bar for the admin dashboard. Today's silver rate leads, then the live
// clock, notifications and the admin's avatar.
  ...
  return (
    <header className="h-16 shrink-0 bg-white/90 backdrop-blur border-b border-silver-200 flex items-center justify-between gap-4 px-4 sm:px-6">
      <div className="flex items-center gap-3 min-w-0">
        ...
        <SilverRatePill manageLink="/dashboard/silver-rate" />
      </div>
